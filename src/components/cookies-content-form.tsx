...
import { updateCookiesContent } from "@/app/actions/content"
...
export function CookiesContentForm({ 
  initialData,
  locale = "ro",
}: { 
  ...
  const [state, formAction, isPending] = useActionState(updateCookiesContent, initialState)
      ...
      <div className="bg-white dark:bg-zinc-900/30 border border-gray-200 dark:border-white/5 rounded-2xl p-6 backdrop-blur-sm shadow-sm space-y-6">
        ...
        <div className="grid gap-2">
          ...
          <Input 
            ...
            required 
            placeholder="Politică de Cookies" 
