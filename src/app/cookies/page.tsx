...
export const metadata = {
  title: "Politică de Cookies - DentyMD",
  description: "Informații despre utilizarea modulelor cookie.",
}
...
export default async function Cookies() {
  ...
  const title = content?.sectionTitle || t["legal.cookies.title"] || "Politică de Cookies"
  
  const defaultBody = t["legal.cookies.defaultBody"] || "<p>Aceasta este politica de cookies implicită. O puteți edita din panoul de administrare.</p>"
